...
namespace Rito.CAT
{
    public static class EditorAutoInjectHelper
    {
        public static void InjectByTr(Transform tr, EditorAutoInjectAttribute atr, Type fieldType, out UnityEngine.Object found)
        {
        ...
        public static void Inject(Component comField, EditorAutoInjectAttribute atr, Type fieldType, out UnityEngine.Object found)
        {
