...
{
    // 2023. 07. 15.
    public static class ComponentExtensionWithNameEqual
    {
        // 멀티스레딩 배제: 공유 스택
        private static readonly Stack<Transform> _dfsSharedStack = new Stack<Transform>(48);

        // Test TODO: 2023-07-15 
        /// <summary>
        /// <para/> 이름 포함 자식 탐색
        /// </summary>
        public static Component Ex_GetComponentInChildren_EQ(this Component @this, Type targetType, 
            string nameEqual,
        ...
        )
        {
            ...
            while (_dfsSharedStack.Count > 0)
            {
                ...
                if (current.name.Equals(nameEqual))
                {
        ...
        /// <para/> 이름 포함 부모 탐색
        /// </summary>
        public static Component Ex_GetComponentInParents_EQ(this Component @this, Type targetType, 
            string nameEqual,
            bool includeSelf, // 자신 포함
            bool evenDisabled // 비활성화 상태 포함
        )
        {
            ...
            while (target != null)
            {
                ...
                if (target.name.Equals(nameEqual))
                {
