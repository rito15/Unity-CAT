...
namespace Rito.CAT.Demo
{
    ...
    {
        [EditorDI(DiMethod.GetComponentInParents, nameIncludes: "NONO", includeInactive: false)]
        public Transform _parents_Fail1;

        [EditorDI(DiMethod.GetComponentInParentsOnly, nameIncludes: "NONO", includeInactive: false)]
        public Transform _parents_Fail2;

        [EditorDI(DiMethod.GetComponentInParents, nameIncludes: "DI", includeInactive: false)]
        public Light _parents_Suc1;

        [EditorDI(DiMethod.GetComponentInParentsOnly, nameIncludes: "DI", includeInactive: false)]
